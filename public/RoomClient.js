...
//绑定this后这个回调函数的this.变量指向全局变量
  ...
  async produce(type, deviceId = null) {
    ...
    /**ignore code to producer much one  video */
    ...
    try {
      ...
      this.producerLabel.set(producer.id,type)
  ...
  closeProducer(type) {
    ...
    // }
    let producer_id ;
    this.producerLabel.forEach(function(value,key){
      if(value === type)
      {
        producer_id = key;
      }  
  ...
  if(producer_id === '')
   ...
   console.log('Close producer', producer_id)
    ...
    this.producerLabel.delete(producer_id)
